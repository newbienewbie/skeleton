...
const commentUserOpinion=sequelize.import('./entity/comment-user-opinion.js');
...
comment.hasMany(commentUserOpinion,{foreignKey:'comment_id'});
commentUserOpinion.belongsTo(user,{foreignKey:'user_id'});
