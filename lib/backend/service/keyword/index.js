 ...
 * @return {Promise}
 */
function findAllByTopicId(topicId){
 ...
 */
function create(topicId,keywords){
 ...
 */
function edit(topicId,keywords){
    return domain.keyword.findAll({
...
module.exports={
    findAllByTopicId,create,edit,
    removeById,removeAllByTopicId,
};