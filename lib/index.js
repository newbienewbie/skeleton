...
function createApp(opts){
    ...
    // 配置模板
    let env =nunjucks.configure(path.join(__dirname,'../frontend/views'),{
        noCache:true,
        express:app,
        autoescape:true
    });
    ...
    // domain 相关
    app.use('/upload/meiying',require('./backend/router/upload.js'));
    app.use('/country',require('./backend/router/country.js'));
    app.use('/language',require('./backend/router/language.js'));
    app.use('/movie',require('./backend/router/movie.js'));
    ...
    // about 模块
    app.use('/about',require('./backend/router/about'));
